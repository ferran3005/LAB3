...
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.Handlers.RouteHandler;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.agent.BdiStates;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.agent.SituatedData;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.goals.RequestDataGoal;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.plans.FindSituatedPlanBody;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.plans.KeepMailboxEmptyPlanBody;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.plans.RegisterPlanBody;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.goals.SPARQLGoal;
import eu.su.mas.dedaleEtu.sid.grupo06.bdi.plans.RequestDataPlanBody;
...
import static eu.su.mas.dedaleEtu.sid.grupo06.common.Constants.*;

public class BDIAgent06 extends SingleCapabilityAgent {
